...
abstract class FileAnnotation @Inject constructor(@Input val name0: String, project: Project) : Named {

    override fun getName(): String = name0

    @Input
    val fileAnnotation = project.objects.property<String>()

    abstract fun applyTo(codeGenerator: CodeGenerator)

    val classId: ClassId
        get() = fileAnnotation.get().let {
